...
<head>
    ...
    <title>About Us - PAUD Qurrota A'yun</title>
...
<body>
    ...
    ?>
    <section id="about">
        <h2><a style="color: #325E95;">Tentang</a> PAUD Qurrota A'yun?</h2>
            ...
            <div class="about-content">
                ...
                <div class="about-images">
                    <div class="grid-item large">
                        <?php
                            if (!empty($foto)) {
                                echo '<img src="admin/' . htmlspecialchars($foto[0]['foto']) . '" alt="Gambar 1">';
                            }
                        ?>
                    </div>
                    <div class="grid-item small">
                        <?php
                            if (!empty($foto[1])) {
                                echo '<img src="admin/' . htmlspecialchars($foto[1]['foto']) . '" alt="Gambar 2">';
                            }
                        ?>
                    </div>
                    <div class="grid-item small">
                        <?php
                            if (!empty($foto[2])) {
                                echo '<img src="admin/' . htmlspecialchars($foto[2]['foto']) . '" alt="Gambar 3">';
                            }
                        ?>
                    </div>
                </div>
    ...
    <section id="vision-mission">
        <h2 style="color: #E73262;" onclick="window.location.href='about_visi_misi.php';">Visi & Misi</h2>
        <h2 style="margin-top: -20px;">Qurrota A'yun</h2>
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            echo '<section id="curriculum">
                    <h2 style="color: #325E95;">Kurikulum</h2>
    ...
    <section id="staff">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="profile-img"><img src="admin/uploads/guru/' . $row['foto'] . '" alt="' . $row['nama'] . '"></div>';
        ...
        <div class="reasons">
            ...
            if (isset($fasilitas) && count($fasilitas) > 0) {
                foreach ($fasilitas as $item) {
                    ...
                    echo '<img src="admin/uploads/fasilitas/' . $item['gambar'] . '" alt="' . $item['judul'] . '">';
