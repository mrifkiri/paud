<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_banner'])) {
        ...
        $query = "UPDATE banner_text SET text = '$new_banner_text' WHERE id = 1";
        if ($conn->query($query) === TRUE) {
        } else {
            echo "Error: " . $conn->error;
        }
...
<body>
    <div class="kelolaSlider">
        ...
        <table border="1">
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM sliders WHERE id = 1";
        ...
        <script>
            ...
            document.querySelectorAll('.edit-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('editForm').action = 'beranda_edit_slider.php?id=' + sliderId; // Set form action dynamically
                });
            });
